...
Input.prototype.addDevice = function (address, name, callback) {
  this.client.addDeviceToInput(this.id, address, name, callback);
};

Input.prototype.removeDevice = function(address, callback) {
  this.client.removeDeviceFromInput(this.id, address, callback);
};
